...
cap = cv.VideoCapture("Oject Detection/YOLO_intro/Videos/cars.mp4") 
...
mask = cv.imread("Oject Detection/CarCounter/mask.png")
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            currentClass = classNames[cls_name]
